    ...
    <br/>
        ...
        <div class="card bg-dark text-white" style="width: 80%; margin: 0 auto;">
            ...
            <div class="facilities-icons1">
                ...
                <div class="facility-item">
                    <i class="fas fa-gift" title="선물"></i>
                    &nbsp;&nbsp;<h6 style="font-size: 15px;">선물</h6>
                </div>
                <div class="facility-item">
        ...
        <div class="card bg-dark text-white" style="width: 80%; margin: 0 auto;">
            <div class="facilities-icons">
                ...
                <div class="popup-info" style="align-items: center;">
                      『모여봐요 동물의 숲』에 등장하는 다양한 해양생물을 
                    코엑스 아쿠아리움에서 만나 보세요! <br>
                    수족관의 수조에는 『모여봐요 동물의 숲』에서 해양생물을 
                    박물관에 기증했을 때 들을 수 있는 부엉씨의 해설과 더불어 
                    사육사의 간단 지식이 기재된 패널이 설치됩니다. <br>
					『모여봐요 동물의 숲』의 BGM과 함께 해양생물을 더욱 실감나게 
					관찰할 수 있는 기회! <br>
					많은 관람 부탁드립니다
                </div>
