        ...
        <div class="swiper-container-wrapper">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="image/popup/battle5.png">
                        <div class="overlay-text-title">
                        </div>       
                    </div>
                    <!-- 추가 이미지 슬라이드 -->
    ...
    <br/>
        ...
        <div class="card bg-dark text-white" style="width: 80%; margin: 0 auto;">
            ...
            <div class="facilities-icons1">
                ...
                <div class="facility-item">
                    <i class="fas fa-cart-plus" title="스토어"></i>
                    &nbsp;&nbsp;<h6 style="font-size: 15px;">스토어</h6>
                </div>
                <div class="facility-item">
                    <i class="fas fa-camera" title="포토존"></i>
                    &nbsp;&nbsp;<h6 style="font-size: 15px;">포토존</h6>
                </div>
                <div class="facility-item">
        ...
        <div class="card bg-dark text-white" style="width: 80%; margin: 0 auto;">
            <div class="facilities-icons">
                ...
                <h6>&nbsp;(월, 화, 수는 운영 안함)</h6><br/>
                <h6>목 : 14:00 ~ 20:00</h6><br/>
                <h6>금 : 14:00 ~ 20:00</h6><br/>
                <h6>토 : 14:00 ~ 20:00</h6><br/>
                <h6>일 : 14:00 ~ 20:00</h6><br/>
                <h6>&nbsp;(입장마감 : 19:30)</h6>
            </div>
        </div>
        <br/>
        <div class="card bg-dark text-white" style="width: 80%; margin: 0 auto;">
            <div class="facilities-icons">
                ...
                <div class="popup-info" style="align-items: center;">
                      배틀그라운드 게임을 오프라인에 구현한 체험형 <br>
                    팝업 스토어로 물총 게임, 탁구 세임, 과녁 맞이기 등 <br>
                    게임에 직접 참여할 수 있고 게임 후 스탬프를 모으면 <br>
                    배틀그라운드 굿즈도 받을 수 있어 성수도 놀거리로 <br>
                    방문해 보기 좋은 장소입니다.  
                </div>
